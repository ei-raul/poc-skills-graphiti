...
class AnthropicConfig:
    ...
    beta_headers: str = "files-api-2025-04-14,skills-2025-10-02,code-execution-2025-08-25"
    ...
    timeout: float = 300.0  # 5 minutes (was 120) - Increased for PDF processing with skills
